...
public class MenuItem_SetLookAndFeel extends JMenuItem {
	...
	public MenuItem_SetLookAndFeel(Prism2Main main, ComponentResizer cr) {
		...
		addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				int response = JOptionPane.showOptionDialog(Prism2Main.get_Prism_DesktopPane(), radioPanel,
