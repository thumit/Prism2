...
public class OptionPane_About extends JOptionPane {
	...
	public OptionPane_About() {
		for (JInternalFrame i: Prism2Main.get_Prism_DesktopPane().getAllFrames()) {
			i.setVisible(false);
		} 
		
		String ExitOption[] = { "OK" };
		int response = JOptionPane.showOptionDialog(Prism2Main.get_Prism_DesktopPane(), new ScrollPane_License_Popup(),
		    ...
		    public void hierarchyChanged(HierarchyEvent e) {
		        ...
		        if (window instanceof Dialog) {
		            ...
		            if (!dialog.isResizable()) {
		                ...
		                dialog.setPreferredSize(new Dimension((int) (Prism2Main.get_main().getWidth() / 1.1), (int) (Prism2Main.get_main().getHeight() / 1.21)));
		            }
		        }
		    }
		});
